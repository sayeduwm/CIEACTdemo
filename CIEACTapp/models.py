...
class UserDatabase(models.Model):
  ...
  POSUNIGRAM=models.CharField(max_length=1000, null=True, blank=True)
  POSBIGRAM=models.CharField(max_length=1200, null=True, blank=True)
  POSTRIGRAM=models.CharField(max_length=1300, null=True, blank=True)
  TEXTVIZ=models.TextField(null=True, blank=True)
