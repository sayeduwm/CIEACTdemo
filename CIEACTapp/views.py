    ...
    if request.method == "GET":
        ...
        for line in lines:
            if line:
                ...
                NoisyORU,NoisyORB,NoisyORT,NoisyORUB,Positive_Unigams,Positive_Bigams,Positive_Trigams,textViz_output=ClassifierWthrs( narrative, U_list,B_list,T_list,hybrid,0.6,0.6,0.6)              
                date=column[1]
                print(date)
                print(textViz_output)
